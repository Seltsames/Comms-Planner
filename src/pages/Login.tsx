      ...
      <div className="w-full max-w-md">
        ...
        <div className="space-y-5 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          <button
            ...
            disabled={submitting}
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-300 bg-white py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 hover:border-slate-400 disabled:opacity-60"
          >
            <GoogleIcon />
          ...
          <p className="text-center text-xs text-slate-500">
            Solo se permiten cuentas de Google Workspace{" "}
            <code className="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-[11px]">
              @didi-labs.com
            </code>
            .
            <br />
            Si tu cuenta no pertenece a esta organización, no podrás acceder.
          </p>
        </div>
      </div>
    </div>
