-- ============================================================
-- Migration 00017: save_campaign_v2 pending overlap guard
-- ============================================================
-- Do NOT auto-approve if there are pending/rejected campaigns
-- overlapping the same time slot (±30min buffer) in the same
