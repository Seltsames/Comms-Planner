-- ============================================================
-- Migration 00021: Per-channel daily limit (was globally applied)
-- ============================================================
-- The v_limit was being set once before the loop based on the
-- combined p_action_keys array. Now it's set per v_action_key
-- inside the FOREACH loop, so each channel gets its own limit.
-- ============================================================
