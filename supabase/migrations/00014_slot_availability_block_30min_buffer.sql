-- ============================================================
-- Migration 00014: Block ±30min buffer on existing schedules
-- DiDi Comms Planner v2 — Supabase Cloud
-- ============================================================
-- For each candidate 30-min slot (07:00 to 22:00):
--   - If ANY other campaign has a schedule that falls within
--     ±30 minutes of the slot (regardless of DRV overlap),
--     mark slot as RED / unavailable.
--   - Otherwise use DRV-overlap severity (green/yellow/red).
-- ============================================================
